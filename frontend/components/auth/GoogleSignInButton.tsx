  ...
  async function handleMobileGoogleLogin() {
    ...
    try {
      ...
      GoogleAuth.initialize({
        clientId: "637710176782-fic04ulgot29307mlf0qlr2elba0sk8j.apps.googleusercontent.com",
      ...
      <div className="flex justify-center w-full">
        {!isNative ? (
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 rounded-full border border-white/10 bg-white/5 py-3 text-sm font-semibold text-white hover:bg-white/10 transition disabled:opacity-50"
          >
