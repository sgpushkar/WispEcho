    ...
    <div className="flex h-screen w-screen items-center justify-center overflow-hidden bg-base px-4">
      ...
      >
        ...
        <div className="mt-6 flex flex-col items-center border-t border-white/5 pt-4">
          <p className="text-xs text-white/40 mb-2">Prefer mobile? Download our app</p>
          <a
            href="/downloads/wispecho.apk"
            download
            className="flex items-center gap-2 rounded-xl bg-white/5 px-4 py-2 text-xs font-medium text-white hover:bg-white/10 transition border border-white/5 shadow-sm"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-accent-soft"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
            Download WispEcho APK
          </a>
        </div>
      </motion.form>
    </div>
